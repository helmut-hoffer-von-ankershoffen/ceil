...
certificate:
  ...
  key_org: "ceil" # Organization Name (eg, company)
...
openvpn:
  ...
  local_subnet: 192.168.0.0 # The local subnet where the RPi is connected
  local_netmask: 255.255.255.0 # The local netmask for the RPi subnet
